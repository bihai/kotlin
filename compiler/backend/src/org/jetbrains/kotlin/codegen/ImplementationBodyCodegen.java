    ...
    private void lookupConstructorExpressionsInClosureIfPresent() {
        ...
        JetVisitorVoid visitor = new JetVisitorVoid() {
            ...
            private void lookupReceiver(@NotNull ReceiverValue value) {
                if (value.exists() && value instanceof ThisReceiver) {
                    if (value instanceof ExtensionReceiver) {
                        lookupInContext(((ExtensionReceiver) value).getDeclarationDescriptor().getExtensionReceiverParameter());
                    } else {
            ...
            private void lookupInContext(DeclarationDescriptor toLookup) {
